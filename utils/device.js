...
var isMobile = function () {
  var _isMobile = false;
  let _ugent = window.navigator.userAgent || window.navigator.vendor || window.opera ;
...
module.exports.getLanguer = function () {
  ...
  const navLanguser = (navigator.language ||navigator.userLanguage||navigator.browserLanguage||navigator.browserLanguage||navigator.systemLanguage).toLowerCase();
