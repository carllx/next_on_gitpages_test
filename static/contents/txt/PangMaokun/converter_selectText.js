...
// 格式化 , sublime中的  '    ' ==\t
strings = strings.replace(/    /img,'\t')
// 将全文每(line) 拆成 array
contents = strings.split(/^([^\t].*)\n/img)
// console.log(contents)
//去除splite造成第一个值是空值""
contents = contents.filter(word => word.length >1)
// console.log(contents)
// let title = {};
// let time = {};
// let author = {};
